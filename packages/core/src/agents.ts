...
export const agentDefinitions: AgentDefinition[] = [
  ...
  { id: "career-source-browser-reader", displayName: "Source Browser Reader", skillPath: "career-os-agents/skills/career-source-browser-reader/SKILL.md", threadPolicy: "per_source", defaultQueue: "browser", description: "Reads one configured source through a generated browser-only skill." },
