...
export default async function OpportunityPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: opportunity }, { data: recommendation }, { data: paths }, { data: events }] = await Promise.all([
